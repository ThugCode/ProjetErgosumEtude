...
<html>
	...
	<body>
		...
		<div class="wrapper">
	        ...
	        <div id="content-wrap">
	        	<div id="page-wrap">
					<div class="page-title"><h1>Affichage des catalogues</h1> <span></span></div>
					<div id="side-content">
						<h4>Choix du catalogue</h4>
						 Choisir une date : <br />
						  <form method="post" action="afficherCatalogues.htm">
						  	<label for="anneeDebut">Année de départ :</label> <br /><input type="text" name="anneeDebut" id="anneeDebut" value="2002" /><br />
						  	<label for="nbAnnees">Nombre d'années :</label> <br /><input type="text" name="nbAnnees" id="nbAnnees" value="2" /><br /><br />
